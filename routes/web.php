...
Route::put('/zasoby/{numer_inwentarzowy}', [ZasobyController::class, 'update'])->name('updatezasoby');
// Delete
Route::delete('/zasoby/{numer_inwentarzowy}', [ZasobyController::class, 'destroy'])->name('deletezasoby');
// Export PDF/excel
